      ...
      m_timer(this)
{
    ...
    // Recalculate time when timestamp changes
    connect(m_configuration, &Common::TimerConfiguration::timestampChanged, this, &Application::calculateTimeElapsed);
}
...
{
    if (m_timer.isActive()) {
        disconnect(&m_timer, &QTimer::timeout, this, &Application::calculateTimeElapsed);
        m_timer.stop();
    }
}

void Application::calculateTimeElapsed()
{
